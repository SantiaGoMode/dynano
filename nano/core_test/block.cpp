...
TEST (block_builder, state)
{
	...
	auto block = builder
	             .state ()
	             .account_address ("dyna_15nhh1kzw3x8ohez6s75wy3jr6dqgq65oaede1fzk5hqxk4j8ehz7iqtb3to")
	             ...
	             .representative_address ("dyna_1stofnrxuz3cai7ze75o174bpm7scwj9jn3nxsn8ntzg784jf1gzn1jjdkou")
...
TEST (block_builder, state_errors)
{
	...
	builder.state ().zero ().account_address ("dyna_1111111111111111111111111111111111111111111111111111hifc8npp").build (ec);
	ASSERT_NO_ERROR (ec);
}
...
TEST (block_builder, open)
{
	...
	auto block = builder
	             .open ()
	             .account_address ("dyna_3h55yod1pycy3epdhm5dzhx49j7cmh6dphnste6w5ys4h6xfi3ybubn9yi7r")
	             .representative_address ("dyna_3h55yod1pycy3epdhm5dzhx49j7cmh6dphnste6w5ys4h6xfi3ybubn9yi7r")
	             .source_hex ("BC63F5560B795E0B2CB7CC6BFBFA23C4AA9BC8BB3E99D309C1FB22793AD807C9")
	             .build (ec);
...
TEST (block_builder, change)
{
	...
	auto block = builder
	             .change ()
	             .representative_address ("dyna_3rropjiqfxpmrrkooej4qtmm1pueu36f9ghinpho4esfdor8785a455d16nf")
...
TEST (block_builder, send)
{
	...
	auto block = builder
	             .send ()
	             .destination_address ("dyna_1gys8r4crpxhp94n4uho5cshaho81na6454qni5gu9n53gksoyy1wcd4udyb")
