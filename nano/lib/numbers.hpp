...
// SI dividers
nano::uint128_t const gDyna_ratio = nano::uint128_t ("1000000000000000000000000000000000"); // 10^33
nano::uint128_t const mDyna_ratio = nano::uint128_t ("1000000000000000000000000000000"); // 10^30
nano::uint128_t const kDyna_ratio = nano::uint128_t ("1000000000000000000000000000"); // 10^27
nano::uint128_t const dyna_ratio = nano::uint128_t ("1000000000000000000000000"); // 10^24
nano::uint128_t const md_ratio = nano::uint128_t ("1000000000000000000000"); // 10^21
nano::uint128_t const uDyna_ratio = nano::uint128_t ("1000000000000000000"); // 10^18
