...
public:
	...
	nano::node & node;
	bool on;
	static uint16_t const rpc_port = nano::is_live_network ? 7086 : 55000;
};
...
public:
	...
	void key_expand ();
	void ledger ();
	void mDyna_to_raw (nano::uint128_t = nano::mDyna_ratio);
	void mDyna_from_raw (nano::uint128_t = nano::mDyna_ratio);
	void node_id ();
	void node_id_delete ();
